...
<template>
    ...
    <NavLayouts>
        <main>
            <!-- Hero section -->
            <article>
                <section class="bg-[url('/svg/multiplr-writters-profile-pic.svg')] bg-no-repeat bg-center bg-cover flex flex-col mt-12 md:mt-0 md:justify-center items-center gap-y-12 h-screen">
            ...
            <article>
                <section>
                    <h3 class="">Trusted by the world’s best</h3>
                </section>
            </article>
        </main>
    </NavLayouts>
